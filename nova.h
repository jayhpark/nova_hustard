...
//	struct free_list *node1_free_lists;
//	struct free_list *node2_free_lists;
...
//	if (cpu < sbi->cpus) {
//		if((cpu >= 0 && cpu < 6) || (cpu >= 12 && cpu < 18))
//			return &sbi->node1_free_lists[cpu];
//		else if((cpu >= 6 && cpu < 12) || (cpu >= 18 && cpu < 24))
//			return &sbi->node2_free_lists[cpu];
//	}
	if (cpu < sbi->cpus)
